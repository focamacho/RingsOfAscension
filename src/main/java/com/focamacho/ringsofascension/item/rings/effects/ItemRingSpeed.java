...
public class ItemRingSpeed extends ItemRingBase {
    ...
    public void tickCurio(String identifier, int index, LivingEntity livingEntity) {
        ...
        if(!livingEntity.hasEffect(MobEffects.MOVEMENT_SPEED)) {
            MobEffectInstance effectInstance = new MobEffectInstance(MobEffects.MOVEMENT_SPEED, Integer.MAX_VALUE, ConfigHolder.ringAmplifierSpeed, false, false);
    ...
    public List<ResourceLocation> getLocations() {
        return super.getLocations(ConfigHolder.ringLocationSpeed);
    }

    @Override
    public boolean isEnabled() {
        return ConfigHolder.ringSpeed;
    }
