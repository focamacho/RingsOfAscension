...
public class ItemRingUndying extends ItemRingBase {
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(new LiteralText("§e" + new TranslatableText("tooltip.ringsofascension.undying_cooldown").asString().replace("secondsHere", "§c" + ConfigRingsOfAscension.ringUndyingCooldown + "§e")));
    }
}
